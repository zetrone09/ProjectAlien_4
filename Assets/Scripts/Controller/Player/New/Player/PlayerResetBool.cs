...
public class PlayerResetBool : StateMachineBehaviour
{
    [Header("isPreformingQuickTurn bool")]
    public string disableRootMotion = "disableRootMotion";
    public bool disableRootMotionSatus = false;

    [Header("isPreformingAction bool")]
    ...
    {
        animator.SetBool(disableRootMotion, disableRootMotionSatus);
